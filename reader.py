...
# MongoDB and registration URL config
# MongoDB connection
...
# Track previously seen cards currently on the reader
current_cards = set()
...
while True:
    ...
    if uid:
        ...
        # If no card is present, clear seen UIDs to detect re-presented cards later
        if current_cards:
